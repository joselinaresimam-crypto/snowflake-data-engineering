-- =========================================================
-- 03_create_weather_hamburg_view.sql
-- Objetivo:
--   Crear una vista en harmonized con métricas de clima
--   y ventas diarias para Hamburg, Germany.
-- =========================================================
...
-- ---------------------------------------------------------
-- 2) Crear o reemplazar la vista harmonized.weather_hamburg
-- ---------------------------------------------------------
